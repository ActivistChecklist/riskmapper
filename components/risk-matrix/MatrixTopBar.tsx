...
export default function MatrixTopBar({ workspace: ws }: Props) {
  return (
    <TooltipProvider delayDuration={400}>
      <div className="mb-3 flex min-h-9 flex-wrap items-center gap-2 sm:gap-3">
        ...
        <input
          ...
          className="min-w-0 max-w-[min(100%,28rem)] flex-1 basis-48 border-b border-black/15 bg-transparent px-0.5 py-0.5 text-sm font-medium text-rm-ink outline-none placeholder:opacity-50 focus-visible:border-rm-primary focus-visible:ring-2 focus-visible:ring-black/10 sm:basis-auto"
        />
